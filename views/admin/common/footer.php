 <!-- footer content -->
        <footer>
          <div class="pull-right">
            Patpedhi Admin &copy; <?php echo date("Y");?>
          </div>
  ...
  <!-- flot js -->
  <!--[if lte IE 8]><script type="text/javascript" src="<?php echo JS_PATH;?>excanvas.min.js"></script><![endif]-->
  ...
  <script type="text/javascript" src="<?php echo JS_PATH;?>flot/jquery.flot.orderBars.js"></script>
  <script type="text/javascript" src="<?php echo JS_PATH;?>flot/jquery.flot.time.min.js"></script>
  <script type="text/javascript" src="<?php echo JS_PATH;?>flot/date.js"></script>
  <script type="text/javascript" src="<?php echo JS_PATH;?>flot/jquery.flot.spline.js"></script>
  <script type="text/javascript" src="<?php echo JS_PATH;?>flot/jquery.flot.stack.js"></script>
  <script type="text/javascript" src="<?php echo JS_PATH;?>flot/curvedLines.js"></script>
