...
<head>
  ...
  <title>Patpedhi Admin Login </title>
      ...
      <div id="login" class="animate form">
        <section class="login_content">
          <form>
            ...
            <div>
              <a class="btn btn-default submit" href="<?php echo BASE_URL;?>adminhome">Log in</a>
            ...
            <div class="separator">
              ...
              <br />
              <div>
                <h1><i class="fa fa-bank" style="font-size: 26px;"></i> Patpedhi</h1>

                <p>&copy; patpedhi.in All Rights Reserved</p>
              </div>
            </div>
          </form>
          <!-- form -->
      ...
      <div id="register" class="animate form">
        <section class="login_content">
          <form>
            ...
            <div>
              <a class="btn btn-default submit" href="<?php echo BASE_URL;?>adminhome">Submit</a>
            </div>
            <div class="clearfix"></div>
            <div class="separator">
